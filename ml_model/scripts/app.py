...
def load_model_and_preprocessor():
    ...
    model_path = 'ml_model/models/xgboost_credit_score_model.pkl'
    preprocessor_path = 'ml_model/models/preprocessor.pkl'
    metrics_path = 'ml_model/models/model_metrics.pkl'
    try:
